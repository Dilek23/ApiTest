...
import baseURLs.ApiSandBoxBitPaceBaseURL;
...
import testData.BitPacesGetToken;
...
public class Post04 extends ApiSandBoxBitPaceBaseURL

{
   ...
   API doc. URL !!---https://dev.bitpace.com/bitpace-merchant-rest-api#getDepositAddressUsingPOST--!!!
    ...
    public void postforToken(){
       ...
       //Set Req Body
       BitPacesGetToken bitPaceGetToken = new BitPacesGetToken();
  ...
  response.prettyPrint();
     ...
     Map<String,Object> actualDataFromRESPONSE = response.as(HashMap.class);//Gson modeli ile
     System.out.println("actualDataFromRESPONSE: " + actualDataFromRESPONSE);

     assertEquals("Invalid authorization token",actualDataFromRESPONSE.get("message"));
